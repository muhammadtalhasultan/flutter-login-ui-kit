...
class SignIn9 extends StatefulWidget {
  const SignIn9({Key? key}) : super(key: key);

  @override
  State<SignIn9> createState() => _SignIn9State();
}

class _SignIn9State extends State<SignIn9> {
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            ...
            borderSide: BorderSide(color: emailController.text.isEmpty?Colors.transparent:const Color(0xFF21899C))
          ),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color.fromRGBO(254, 152, 121, 1),)
              ),
              child: Text(
                'View',
                textAlign: TextAlign.center,
  ...
  Widget buildNoAccountText(){
    return Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.center,
      children: <Widget>[
        const Expanded(flex: 2,child: Divider(color: Color(0xFF969AA8),)),
        Expanded(
          flex: 3,
          child: Text(
            'Don’t Have Account?',
